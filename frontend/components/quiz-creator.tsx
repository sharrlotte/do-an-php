					...
					<div className="mx-auto max-w-4xl">
						<div className="mb-6 rounded-lg bg-[#e9d8f4] p-8">
							...
							{currentQuestion.image ? (
								...
								<Button
									variant="outline"
									className="mb-6 h-64 w-full border border-dashed bg-white/50"
								...
								{currentQuestion.answers.map((answer) => (
									<div key={answer.id} className="group relative">
										<div className={`${COLORS[answer.color as keyof typeof COLORS]} rounded-md p-4 text-white`}>
											<div className="flex items-center">
												<div
													className={`mr-3 flex h-6 w-6 cursor-pointer items-center justify-center rounded-md border border-white ${
